...
for root, dirs, files in os.walk(mypath):
     ...
     for name in dirs:
        ...
        for filename in glob.glob(os.path.join(htmllink, '*.html')):
            ...
            html2 = html2text.html2text(open(filename).read())
            ...
            # findallObj = re.findall(r'Subject:(.*?)From', str1, re.M)
            #findallObj = re.findall(r'Subject:(.*?)Properties', str1, re.M)
            ...
            with open('C:\\Users\\sidharth.m\\Desktop\\Project_sid_35352\\Final2.csv', 'a', encoding="utf-8") as f:
